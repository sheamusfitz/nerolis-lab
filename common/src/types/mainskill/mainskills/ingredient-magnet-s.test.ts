...
describe('IngredientMagnetS', () => {
  it('should have correct basic properties', () => {
    ...
    expect(IngredientMagnetS.description({ skillLevel: 1 })).toBe('Gets you 6 ingredients chosen at random.');
  ...
  it('should calculate correct activation amounts', () => {
    const level1Amount = IngredientMagnetS.activations.ingredients.amount({ skillLevel: 1 });
    const level6Amount = IngredientMagnetS.activations.ingredients.amount({ skillLevel: 6 });
