...
describe('EnergizingCheerS', () => {
  it('should have correct basic properties', () => {
    ...
    expect(EnergizingCheerS.description(1)).toBe('Restores 14 Energy to one random Pokémon on your team.');
  ...
  it('should calculate correct activation amounts', () => {
    expect(EnergizingCheerS.activations.energy.amount(1)).toBe(14);
    expect(EnergizingCheerS.activations.energy.amount(2)).toBe(17.1);
    expect(EnergizingCheerS.activations.energy.amount(3)).toBe(22.5);
    expect(EnergizingCheerS.activations.energy.amount(4)).toBe(28.8);
    expect(EnergizingCheerS.activations.energy.amount(5)).toBe(38.2);
    expect(EnergizingCheerS.activations.energy.amount(6)).toBe(50.6);
  });
